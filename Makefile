#############################################################################
# Makefile for building: cs4379b-interface
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sun Feb 15 15:24:25 2015
# Project:  cs4379b-interface.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.8.5/bin/qmake -o Makefile cs4379b-interface.pro
#############################################################################
...
Makefile: cs4379b-interface.pro  /usr/local/Trolltech/Qt-4.8.5/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.8.5/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/gcc-base.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/gcc-base-unix.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cs4379b-interface1.0.0/ && $(COPY_FILE) --parents dialog.h .tmp/cs4379b-interface1.0.0/ && $(COPY_FILE) --parents dialog.cpp main.cpp .tmp/cs4379b-interface1.0.0/ && (cd `dirname .tmp/cs4379b-interface1.0.0` && $(TAR) cs4379b-interface1.0.0.tar cs4379b-interface1.0.0 && $(COMPRESS) cs4379b-interface1.0.0.tar) && $(MOVE) `dirname .tmp/cs4379b-interface1.0.0`/cs4379b-interface1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cs4379b-interface1.0.0
...
moc_dialog.cpp: dialog.h
	/usr/local/Trolltech/Qt-4.8.5/bin/moc $(DEFINES) $(INCPATH) dialog.h -o moc_dialog.cpp
